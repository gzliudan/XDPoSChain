...
// RPC packet types
const (
	PingPacket        = 1 // zero is 'reserved', not used by XDPoS discovery v4.
	PongPacket        = 2
	FindnodePacket    = 3
	NeighborsPacket   = 4
	PingPacketXdc     = 5 // PingPacketXdc is the ping packet for XDPoS discovery v4.
	ENRRequestPacket  = 6
	ENRResponsePacket = 7
)
...
func (req *Ping) Kind() byte     { return PingPacketXdc }
