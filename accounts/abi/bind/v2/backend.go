...
type ContractTransactor interface {
	...
	// TransactionByHash retrieves the transaction associated with the hash. The pool of
	// pending transactions is checked in addition to the blockchain, and the isPending
	// return value indicates whether the transaction has been mined yet.
