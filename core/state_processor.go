...
// be nil; the state it finalises is evm.StateDB (see finaliseTxState).
...
// evm.StateDB (see finaliseTxState).
...
// the index the state has at that moment, and only the caller knows the index.
